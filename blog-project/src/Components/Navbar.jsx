    ...
    return (
        <header className="fixed bg-black top-0 left-0 right-0 text-white">
            <nav className="px-4 max-w-7xl mx-auto flex justify-between items-center py-4">
                <a href="/" className="text-xl font-bold text-white hover:text-orange-500">
                    Reyaz<span className="text-orange-500">Blog</span>
                </a>

                {/* navitems */}
                <ul className="md:flex gap-12 text-lg hidden ">
                    {
                        navItems.map(({ link, path }) => <li className="text-white hover:text-orange-500 transition-all ease duration-300" key={path}>
